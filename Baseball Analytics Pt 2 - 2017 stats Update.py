...
# Filter `pos_df` to eliminate players who played 10% or more of their games as
...
#Model 1: Logistic Regression: Binomial classification
...
predictions_lr = cross_val_predict(lr, features, target, cv=10)
...
# Create predictions using cross validation
predictions_rf = cross_val_predict(rf, features, target, cv=10)
